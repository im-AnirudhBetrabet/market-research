...
Analysis Timestamp: 2026-06-07 21:02:11.171300
...
Strongest composite signal: Gift Up + SP500 Up + VIX Down (92.31%)
Composite coverage: 22.74%

## Key Findings

1. Gift Return remains the strongest individual factor by correlation.
2. SP500 Return achieves the highest individual directional accuracy.
3. Gift Return and SP500 Return exhibit low inter-factor correlation (0.252), suggesting complementary information.
4. Composite signals substantially outperform individual factors.
5. The strongest composite signal achieved 92.31% directional accuracy with 22.74% coverage.
...
| Signal                          | Accuracy | Coverage | Observations |
|---------------------------------|---------:|---------:|-------------:|
| Gift Up + SP500 Up + VIX Down   |   92.31% |   22.74% |          377 |
| Gift Up + SP500 Up              |   90.60% |   33.35% |          553 |
| Gift Down + SP500 Down + VIX UP |   81.06% |   15.92% |          264 |
| Gift Down + SP500 Down          |   73.89% |   24.49% |          406 |
...
- Results support further multi-factor research.